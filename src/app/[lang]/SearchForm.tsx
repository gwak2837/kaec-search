  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="relative">
        ...
        <input
          className="w-full p-3 md:p-4 px-12 md:px-12 sm:text-lg md:text-xl placeholder-gray-500 dark:bg-gray-900 bg-gray-100 border-2 border-gray-200 dark:border-gray-800 rounded-lg 
        ...
        <input
          className="absolute z-10 top-1/2 -translate-y-1/2 right-5 cursor-pointer sm:text-lg md:text-xl text-gray-500"
          type="reset"
          value="X"
