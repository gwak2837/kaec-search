...
export default function CourseCard({ course, lang }: Props) {
  ...
  return (
    <>
      <li
        className="grid border grid-rows-[auto_1fr] rounded overflow-hidden cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800"
      ...
      >
        ...
        />
        <h4 className="font-bold p-4 text-lg md:text-xl">
